    ...
    <div className="mb-8 rounded-lg bg-white p-8 pb-12 shadow-lg">
      ...
      <div className="mt-8">
        <button
          ...
          className="ease inline-block cursor-pointer rounded-full bg-green-600 px-8 py-3 text-lg font-medium text-white transition duration-500 hover:bg-green-500"
        >
          Post Comment
        </button>
        {showSuccessMessage && (
